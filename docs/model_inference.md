...
| `advanced_options:temp_buffer_dir` | Redirect temporary OpenVX Buffers in x86. Applicable only for x86 run | Valid directory path | /dev/shm | This option is currently applicable only when using Python for Inference on x86 PC|
