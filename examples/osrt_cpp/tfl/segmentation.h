...
#ifndef TENSORFLOW_LITE_EXAMPLES_SEG_IMAGE_H_
#define TENSORFLOW_LITE_EXAMPLES_SEG_IMAGE_H_
...
}  // namespace seg_images
}  // namespace tflite

#endif  // TENSORFLOW_LITE_EXAMPLES_SEG_IMAGE_H_
