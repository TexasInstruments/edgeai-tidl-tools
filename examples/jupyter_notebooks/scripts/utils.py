...
def get_benchmark_output(benchmark_dict):
    ...
    return total_time/1000000, proc_time/1000000, write_total/1000000, read_total/1000000
...
def get_eval_configs(task_type, runtime_type, num_quant_bits, last_artifacts_id=None):
