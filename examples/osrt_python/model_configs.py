import os
import platform
from config_utils import AttrDict, create_model_config
...
models_configs = {
    ...
    ### Experimental - yolov7-tiny onnx ###
    # 'od-yolov7-tiny' : create_model_config(
    #         preprocess=AttrDict(
    #             resize=640,
    #             crop=640,
    #             data_layout='NCHW',
    ...
    #         session=AttrDict(
    #             session_name='onnxrt',
    #             model_path=os.path.join(models_base_path, '/data/hdd/users/a0508577/work/edgeai-algo/edgeai-modelzoo-cl/models/vision/detection/coco/edgeai-mmyolo/yolov7_tiny_lite_syncbn_fast_640x640_20230830_model.onnx'),
    #             meta_layers_names_list = os.path.join(models_base_path, '/data/hdd/users/a0508577/work/edgeai-algo/edgeai-modelzoo-cl/models/vision/detection/coco/edgeai-mmyolo/yolov7_tiny_lite_syncbn_fast_640x640_20230830_model.prototxt'),
    #             meta_arch_type=6,
    #             input_mean=[0, 0, 0],
    #             input_scale=[0.003921568627,0.003921568627,0.003921568627],
    #             input_optimization=True),
    ...
    #                 resize_with_pad=True, keypoint=False, object6dpose=False, 
    #                 normalized_detections=False,
    #                 shuffle_indices=None, squeeze_axis=None, reshape_list=[(-1,6)], ignore_index=None
    #             ),
    #         task_type = 'detection',
    #         extra_info=AttrDict(
    #             od_type = 'YoloV5',
