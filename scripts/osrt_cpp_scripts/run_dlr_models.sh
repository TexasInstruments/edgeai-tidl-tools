...
do
 echo $val
  ./bin/Release/dlr_main -z "/home/a0496663/edgeai-tidl-apps/samples/${val}/" -v 1 -i "test_data/ADE_val_00001801.jpg"  -l "test_data/labels.txt"  -d 1  -y "cpu"
...
do
 echo $val
  ./bin/Release/dlr_main -z "/home/a0496663/edgeai-tidl-apps/samples/${val}/" -v 1 -i "test_data/airshow.jpg"  -l "test_data/labels.txt"  -d 1  -y "cpu"

done

#ss-dlr-modelzoo-recommended
DataList="ss-5720_tvmdlr_edgeai-tv_fpnlite_aspp_regnetx800mf_cocoseg21_512x512_20210405_onnx"
for val in $DataList;
do
 echo $val
  ./bin/Release/dlr_main -z "/home/a0496663/edgeai-tidl-apps/samples/${val}/" -v 1 -i "test_data/ADE_val_00001801.jpg"  -l "test_data/labels.txt"  -d 1  -y "cpu"
