...
if((${HOST_CPU} STREQUAL  "x86") AND (${TARGET_CPU}  STREQUAL  "x86"))
  ...
  message(STATUS "Directory of ONNX_DEPS: ${CMAKE_CURRENT_LIST_DIR}/../../tools/osrt_deps/onnx_1.15.0_x86_u22/")
  if (EXISTS ${CMAKE_CURRENT_LIST_DIR}/../../tools/osrt_deps/onnx_1.15.0_x86_u22/)
    set(ONNXRT_INSTALL_DIR ${CMAKE_CURRENT_LIST_DIR}/../../tools/osrt_deps/onnx_1.15.0_x86_u22/)
  else()
